...
from metatensor.operations._utils import _check_gradient_presence_raise
...
def empty_like_block(
    ...
    if gradients is None:
        ...
        _check_gradient_presence_raise(block=block, parameters=gradients, fname="empty_like")
