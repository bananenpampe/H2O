...
from .nonlinear import metatensorMLPLazy, metatensorMLPLazyEnsemble
...
class EnsembleBPNNInteraction(torch.nn.Module):
    ...
    def __init__(self, n_out: int,
        ...
        self.model = metatensorMLPLazyEnsemble(n_out, 
                                      n_hidden, 
                                      n_hidden_layers, 
                                      activation,
                                      w_bias,
