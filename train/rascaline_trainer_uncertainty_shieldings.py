...
from nn.aggregation import BPNNAtomWiseAggregationVar, StructureWiseAggregation
from nn.response import ForceUncertaintyRespone, UnitResponse
from nn.loss import EnergyForceLoss, GeneralLossUQ, GeneralLoss, EnergyForceUncertaintyLoss, CRPS
...
class BPNNRascalineModule(pl.LightningModule):
    ...
    def __init__(self,
                 ...
                 aggregation=BPNNAtomWiseAggregationVar(),#StructureWiseAggregation(mode="passthrough"),#
    ...
    def configure_optimizers(self):
        optimizer = torch.optim.Adam(self.parameters(),lr=1e-1, amsgrad=True)
        return {
            "optimizer": optimizer,
            "lr_scheduler": {
