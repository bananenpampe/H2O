...
def get_LE_splines(max_radial=8, max_angular=6, cutoff=5.0):
...
def test_LE_splines(max_radial=8, max_angular=6, cutoff=5.0):
    ...
    spline_points = get_LE_splines(max_radial=max_radial, max_angular=max_angular, cutoff=cutoff)
